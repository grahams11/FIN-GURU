 ...
 * Auto-triggers scan at 3:58pm EST for overnight setups
...
export class GhostScheduler {
   ...
   * Checks every minute if we're in the 3:58-4:00pm EST window
   */
  static start(): void {
    ...
    console.log('✅ Ghost scheduler active - monitoring 3:58-4:00pm EST window');
  }
